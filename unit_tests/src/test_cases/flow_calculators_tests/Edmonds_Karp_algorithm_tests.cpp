...
{
	EXPECT_EQ(*flow_calculators::matrix_of_flows<FullSymmetricMatrix>(*this->test_graph, flow_calculators::Edmonds_Karp_algorithm), FullSymmetricMatrix(non_oriented_test_graph::get_flows()));
}
