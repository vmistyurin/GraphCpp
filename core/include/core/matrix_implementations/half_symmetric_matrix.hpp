#ifndef GRAPH_CORE_HALF_SYMMETRIC_MATRIX_HPP
#define GRAPH_CORE_HALF_SYMMETRIC_MATRIX_HPP
...
namespace graphcpp
{
	...
	public:
		...
		void make_rearranged(const std::vector<msize>& new_nums, SymmetricMatrixBase& memory) const override;
